...
int conv2d_1x1_vl128_s8(int8_t* inputs, int8_t* outputs, int8_t* filters, 
        ...
        for (int _c = c; _c < min(c+c_block,num_channel); _c+=16) {
            for (int k = 0; k < num_filters; k += k_block) {
                for (int _k = k; _k < min(k+k_block, num_filters); _k++) {
                    weight = vld1q_s8((const int8_t*)filters+_k*num_channel+_c);
                        ...
                        for (int w = 0; w < out_width; w += w_block) {
                            for (int _h = h; _h < min(h+h_block,out_height); _h++) {
                                for (int _w = w; _w < min(w+w_block,out_width); _w++) {
                                    input = vld1q_s8(inputs+_c*height*width+(_h*width+_w)*16);
                                    out_idx = ((_k/(out_vlen>>3)*out_height*+_h)*out_width+_w)*(out_vlen>>3)+(int)_k%(out_vlen>>3);
                                    outputs[out_idx] += vaddvq_s8(vmulq_s8(weight,input));
...
int conv2d_1x1_vl256_s8(int8_t* inputs, int8_t* outputs, int8_t* filters, 
                        int height, int width,int num_filters, int num_channel,
                        int h_block, int w_block, int c_block, int k_block) {
    int filter_height = 3;
    int filter_width = 3;
...
int conv2d_1x1_vl512_s8(int8_t* inputs, int8_t* outputs, int8_t* filters, 
                        int height, int width,int num_filters, int num_channel,
                        int h_block, int w_block, int c_block, int k_block) {
    int filter_height = 3;
    int filter_width = 3;
...
int conv2d_1x1_vl128_s1(int8_t* inputs, int8_t* outputs, int8_t* filters, 
                        int height, int width,int num_filters, int num_channel,
                        int h_block, int w_block, int c_block, int k_block) {
    int filter_height = 3;
    int filter_width = 3;
...
int conv2d_1x1_vl256_s1(int8_t* inputs, int8_t* outputs, int8_t* filters, 
                        int height, int width,int num_filters, int num_channel,
                        int h_block, int w_block, int c_block, int k_block) {
    int filter_height = 3;
    int filter_width = 3;
...
int conv2d_1x1_vl512_s1(int8_t* inputs, int8_t* outputs, int8_t* filters, 
                        int height, int width,int num_filters, int num_channel,
                        int h_block, int w_block, int c_block, int k_block) {
    int filter_height = 3;
    int filter_width = 3;
