#ifndef _DWCONV2d_3x3_
#define _DWCONV2d_3x3_
...
int dwconv2d_3x3_vl128_s8(int8_t* inputs, int8_t* outputs, int8_t* filters,
    ...
    for (int c = 0; c < num_channel; c += c_block) {
        for (int _c = c; _c < min(c+c_block,num_channel); _c += 16) {
            ...
            weight_cache_0 = vld1q_s8((const int8_t*)filters+_c*filter_height*filter_width+0);
            weight_cache_1 = vld1q_s8((const int8_t*)filters+_c*filter_height*filter_width+16);
            weight_cache_2 = vld1q_s8((const int8_t*)filters+_c*filter_height*filter_width+32);
            weight_cache_3 = vld1q_s8((const int8_t*)filters+_c*filter_height*filter_width+48);
            weight_cache_4 = vld1q_s8((const int8_t*)filters+_c*filter_height*filter_width+64);
            weight_cache_5 = vld1q_s8((const int8_t*)filters+_c*filter_height*filter_width+80);
            weight_cache_6 = vld1q_s8((const int8_t*)filters+_c*filter_height*filter_width+96);
            weight_cache_7 = vld1q_s8((const int8_t*)filters+_c*filter_height*filter_width+112);
            weight_cache_8 = vld1q_s8((const int8_t*)filters+_c*filter_height*filter_width+128);
                    ...
                    for (int _h = h; _h < min(h+h_block,out_height); _h++) {
                        for (int _w = w; _w < min(w+w_block,out_width); _w++) {
                            // __builtin_prefetch(inputs + _c * height * width + ((_h ) * width + _w) * 16, 0, 3);
                                    ...
                                    vst1q_s8((outputs+_c*out_width*out_height+(_h*out_width+_w)*16),output);

                                    if (_c+16 >= num_channel-1) {
                                        vst1q_s8((outputs+_c*out_width*out_height+(_h*out_width+_w)*16),vmaxq_s8(vdupq_n_s8(0),(vld1q_s8(outputs+_c*out_width*out_height+(_h*out_width+_w)*16))));
                                    }
...
int dwconv2d_3x3_vl256_s8(int8_t* inputs, int8_t* outputs, int8_t* filters,
                        int height, int width,int num_filters, int num_channel,
                        int h_block, int w_block, int c_block, int k_block) {
    int filter_height = 3;
    int filter_width = 3;
    ...
    for (int c = 0; c < num_channel; c += c_block) {
        for (int _c = c; _c < min(c+c_block,num_channel); _c += 32) {
            ...
            weight_cache_0 = vld1q_s8_x2((const int8_t*)filters+_c*filter_height*filter_width+32*0);
            weight_cache_1 = vld1q_s8_x2((const int8_t*)filters+_c*filter_height*filter_width+32*1);
            weight_cache_2 = vld1q_s8_x2((const int8_t*)filters+_c*filter_height*filter_width+32*2);
            weight_cache_3 = vld1q_s8_x2((const int8_t*)filters+_c*filter_height*filter_width+32*3);
            weight_cache_4 = vld1q_s8_x2((const int8_t*)filters+_c*filter_height*filter_width+32*4);
            weight_cache_5 = vld1q_s8_x2((const int8_t*)filters+_c*filter_height*filter_width+32*5);
            weight_cache_6 = vld1q_s8_x2((const int8_t*)filters+_c*filter_height*filter_width+32*6);
            weight_cache_7 = vld1q_s8_x2((const int8_t*)filters+_c*filter_height*filter_width+32*7);
            weight_cache_8 = vld1q_s8_x2((const int8_t*)filters+_c*filter_height*filter_width+32*8);
                ...
                for (int w = 0; w < out_width; w += w_block) {
                    for (int _h = h; _h < min(h+h_block,out_height); _h++) {
                        for (int _w = w; _w < min(w+w_block,out_width); _w++) {
                            ...
                            vst1q_s8_x2((outputs+_c*out_width*out_height+(_h*out_width+_w)*32),output);

                            if (_c+32 >= num_channel-1) {
                               vst1q_s8((outputs+_c*out_width*out_height+(_h*out_width+_w)*32),vmaxq_s8(vdupq_n_s8(0),(vld1q_s8(outputs+_c*out_width*out_height+(_h*out_width+_w)*32))));
                               vst1q_s8((outputs+_c*out_width*out_height+(_h*out_width+_w)*32+16),vmaxq_s8(vdupq_n_s8(0),(vld1q_s8(outputs+_c*out_width*out_height+(_h*out_width+_w)*32+16))));
                            }
...
int dwconv2d_3x3_vl512_s8(int8_t* inputs, int8_t* outputs, int8_t* filters,
                        int height, int width,int num_filters, int num_channel,
                        int h_block, int w_block, int c_block, int k_block) {
    int filter_height = 3;
    int filter_width = 3;
    ...
    for (int c = 0; c < num_channel; c += c_block) {
        for (int _c = c; _c < min(c+c_block,num_channel); _c += 64) {
            ...
            weight_cache_0 = vld1q_s8_x4((const int8_t*)filters+_c*filter_height*filter_width+64*0);
            weight_cache_1 = vld1q_s8_x4((const int8_t*)filters+_c*filter_height*filter_width+64*1);
            weight_cache_2 = vld1q_s8_x4((const int8_t*)filters+_c*filter_height*filter_width+64*2);
            weight_cache_3 = vld1q_s8_x4((const int8_t*)filters+_c*filter_height*filter_width+64*3);
            weight_cache_4 = vld1q_s8_x4((const int8_t*)filters+_c*filter_height*filter_width+64*4);
                ...
                for (int w = 0; w < out_width; w += w_block) {
                    for (int _h = h; _h < min(h+h_block,out_height); _h++) {
                        for (int _w = w; _w < min(w+w_block,out_width); _w++) {
                            ...
                            vst1q_s8_x4((outputs+_c*out_width*out_height+(_h*out_width+_w)*64),output);

                            if (_c+64 >= num_channel-1) {
                                vst1q_s8((outputs+_c*out_width*out_height+(_h*out_width+_w)*64),vmaxq_s8(vdupq_n_s8(0),(vld1q_s8(outputs+_c*out_width*out_height+(_h*out_width+_w)*64))));
                                vst1q_s8((outputs+_c*out_width*out_height+(_h*out_width+_w)*64+16),vmaxq_s8(vdupq_n_s8(0),(vld1q_s8(outputs+_c*out_width*out_height+(_h*out_width+_w)*64+16))));
                                vst1q_s8((outputs+_c*out_width*out_height+(_h*out_width+_w)*64+32),vmaxq_s8(vdupq_n_s8(0),(vld1q_s8(outputs+_c*out_width*out_height+(_h*out_width+_w)*64+32))));
                                vst1q_s8((outputs+_c*out_width*out_height+(_h*out_width+_w)*64+48),vmaxq_s8(vdupq_n_s8(0),(vld1q_s8(outputs+_c*out_width*out_height+(_h*out_width+_w)*64+48))));
                            }
                        }
                    }
                } 
